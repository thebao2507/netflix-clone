...
const Movie = ({ item }) => {
    ...
    return (
        <Link to={link} onClick={ async () => await alert("phim chưa có xem tạm trailer")}>
            <div className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
                <img
                    ...
                    alt={item?.title}
                />
                <div className='absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-70 text-white'>
